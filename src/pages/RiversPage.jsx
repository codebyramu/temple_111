            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-14 items-center ${i % 2 === 1 ? "lg:[&>*:first-child]:order-2" : ""}`}>
              ...
              <Reveal delay={0.1}>
                <div>
                  ...
                  <p className="font-['Cormorant_Garamond'] italic text-stone-600 text-xl mb-6">{r.tagline}</p>
                  <p className="text-stone-600 text-base font-light leading-relaxed mb-4">{r.desc}</p>
                  ...
                  <div className="mt-6 bg-amber-50 border border-amber-100 rounded-xl px-5 py-4">
                    ...
                    <p className="text-stone-700 text-sm">{r.significance}</p>
                  </div>
                </div>
              </Reveal>
            </div>
